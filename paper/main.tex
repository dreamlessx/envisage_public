...
region, and full face. On the HDA Plastic Surgery benchmark (67 test
pairs, 4 procedures), \method{} achieves 0.802 ArcFace for rhinoplasty
...
\begin{table}[t]
\centering
\caption{Per-procedure results on the HDA test set (67 pairs). ArcFace
...
\midrule
Orthognathic & Prior (SD~1.5)       & 10 & \best{0.568}   & 0.399          & --    \\
