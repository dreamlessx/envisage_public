...
we show relied on compositing for 97\% of its identity score), 0.811
...
prediction, it achieved ArcFace 0.509 for rhinoplasty, and
decomposition revealed that 0.499 of that score was attributable to
compositing rather than the diffusion model itself (0.023 without
...
(637 pairs, 65 evaluated) showing 0.871 overall ArcFace (+58\%
...
revealed that 97\% of LandmarkDiff's ArcFace score originated from
composited pixels rather than generated content (0.499 composited vs.\
...
97\% of the identity score originated from pixels copied from the input
rather than generated by the model (0.499 composited vs.\ 0.023 without).
...
\midrule
Blepharo.    & LandmarkDiff         & 36 & 0.670          & 0.388          &       \\
             & \method{} (ours)     & 36 & \best{0.958}   & 0.403          & 0.478 \\
\midrule
Rhytidectomy & LandmarkDiff         & 13 & 0.360          & 0.369          &       \\
             & \method{} (ours)     & 13 & \best{0.811}   & 0.471          & 0.519 \\
\midrule
\textbf{Overall} & LandmarkDiff     & 65 & 0.551         & 0.384          &       \\
                 & \method{} (ours) & 65 & \best{0.871}  & 0.397          & 0.499 \\
\bottomrule
\end{tabular}
\end{table}

For context, LandmarkDiff's composited ArcFace of 0.509 (rhinoplasty)
...
most subjects fall in MST~5 to 6, with one subject at MST~8 and none in
MST~1 to 4 or 9 to 10. Within the represented tones, ArcFace ranges from
...
\begin{table}[t]
\centering
\caption{Metrics stratified by Monk Skin Tone Scale. Tones 1 to 2, 4, 9 to 10
...
\midrule
   & \textbf{Overall} & 104 & 0.871 & 0.397 & 0.499 \\
\bottomrule
\end{tabular}
\end{table}
...
fixing them (0.499 ArcFace composited vs.\ 0.023 without). \method{}
