...
a post-processing step but found that it degrades automated identity
metrics (ArcFace 0.631 to 0.433), consistent with the observation that
CodeFormer replaces facial details with its learned codebook. We report
