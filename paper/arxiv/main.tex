...
125 test, 4 procedures), \method{} achieves 0.802 ArcFace for rhinoplasty
(compared to 0.607 for LandmarkDiff, a full-face diffusion baseline that
we show relied on compositing for 97\% of its identity score) and 0.745
...
(637 pairs, 125 test) showing 0.802 ArcFace for rhinoplasty (+32\%
over LandmarkDiff) and competitive LPIPS across all four procedures,
...
Eyebrow, Facelift, FacialBones), which we mapped to four surgical
procedures: rhinoplasty (174 pairs), blepharoplasty (258 pairs, combining
Eyelid and Eyebrow categories), rhytidectomy (98 pairs), and orthognathic
(107 pairs). We created a stratified 80/20 train/test split (seed 42),
yielding 125 test pairs: 34 rhinoplasty, 51 blepharoplasty, 19
rhytidectomy, and 21 orthognathic. All images were processed at
...
\begin{table}[t]
\centering
\caption{Per-procedure results on the HDA test set (125 pairs from
...
\textbf{SSIM} $\uparrow$ \\
\midrule
Rhinoplasty  & LandmarkDiff         & 34 & 0.607          & 0.380          & --    \\
             & \method{} (ours)     & 34 & \best{0.802}   & \best{0.380}   & 0.549 \\
\midrule
Blepharo.    & LandmarkDiff         & 51 & 0.670          & 0.388          & --    \\
             & \method{} (ours)     & 51 & \best{0.745}   & \best{0.370}   & 0.492 \\
\midrule
Rhytidectomy & LandmarkDiff         & 19 & \best{0.360}   & 0.369          & --    \\
             & \method{} (ours)     & 19 & 0.173          & \best{0.369}   & 0.554 \\
\midrule
Orthognathic & LandmarkDiff         & 21 & \best{0.568}   & 0.399          & --    \\
             & \method{} (ours)     & 21 & --             & \best{0.395}   & 0.533 \\
\midrule
\textbf{Overall} & LandmarkDiff     & 125 & 0.551         & 0.384          & --    \\
                 & \method{} (ours) & 125 & \best{0.631}  & \best{0.377}   & 0.524 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/decomposed.pdf}
