...
with non-surgical region ArcFace of 0.922--0.978. These results are obtained with zero task-specific
...
full face, revealing that our approach achieves 0.922--0.978 identity
...
\begin{table}[t]
\centering
\caption{Metrics stratified by Monk Skin Tone Scale. Tones 1--2, 4, 9--10
...
rhinoplasty 0.725), with non-surgical region ArcFace of 0.922--0.978. The most productive next
